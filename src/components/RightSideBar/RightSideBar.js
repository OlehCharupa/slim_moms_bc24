        ...
        <>
            ...
            <div className={style.right__SideBar}>
                <div className={style.block__left}>
                    ...
                    {!!daySummary.length ? <ul className={style.list}>
                        <li className={style.list__item}>
                            <p className={style.list__item_text}>Осталось
                            <span className={style.list__item_text_right}>
                                    {daySummary.kcalLeft ? (daySummary.kcalLeft, 'ккал') : '000 ккал'}
                                </span></p>
                        </li>
                        <li className={style.list__item}>
                        ...
                        <li className={style.list__item}>
                            ...
                            <span className={style.list__item_text_right}>
                                    {daySummary.percentsOfDailyRate ? (daySummary.percentsOfDailyRate, 'ккал') : '000 ккал'}
                                </span></p>
                        </li>
                    </ul>
