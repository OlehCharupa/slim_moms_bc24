export const isLogin = (state) => !!state.token; //когда будет готова логика для авторизации, поместить ее сюда, или удалить, заменив в PrivateRoutes, PublicRoutes, Navigation.
